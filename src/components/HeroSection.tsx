...
export function HeroSection() {
  return (
    <section className="-mt-[96px] relative z-0 min-h-screen overflow-hidden">
      <div 
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 pt-[96px] py-20 flex items-center min-h-screen">
